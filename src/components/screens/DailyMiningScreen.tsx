    ...
    <div className="w-full flex-1 px-4 py-3 space-y-4 pb-8">
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 200 200">
            ...
            <circle
              ...
              strokeWidth="10"
              strokeDasharray="552"
              strokeDashoffset={user.miningActive ? '110' : '552'}
              strokeLinecap="round"
          ...
          <div className="relative w-44 h-44 rounded-full flex items-center justify-center p-2 group-hover:scale-105 transition-all">
            ...
            <div className="absolute -bottom-3 px-3 py-1 rounded-full bg-[#0B0E17]/95 border border-[#FF9933]/50 shadow-2xl backdrop-blur-md flex items-center gap-2 z-10">
              ...
              <span className="text-xs font-mono font-bold text-white tracking-wide">
                {user.miningActive ? 'MINING ACTIVE' : 'MINING PAUSED'}
              </span>
      ...
      <button
        ...
        className={`w-full py-3.5 px-6 rounded-2xl font-bold text-sm flex items-center justify-center gap-2.5 shadow-xl transition-all duration-200 active:scale-98 ${
          user.miningActive
            ...
            : 'bg-[#252C3D] text-white border border-white/20 hover:bg-[#30394F]'
        }`}
      >
        <Zap className="w-4 h-4 fill-current" />
        <span>{user.miningActive ? 'CONTINUE MINING' : 'START MINING SESSION'}</span>
      </button>
      ...
      <div className="grid grid-cols-3 gap-2 pt-1">
        <div className="p-3 rounded-2xl bg-[#111420] border border-white/10 text-center">
          ...
          <div className="text-sm font-bold text-[#FF9933] font-mono mt-1">+0.25</div>
          <div className="text-[10px] text-slate-500">VDC / hour</div>
        </div>
        <div className="p-3 rounded-2xl bg-[#111420] border border-white/10 text-center">
          <div className="text-[10px] font-mono text-slate-400 uppercase">Session</div>
          <div className="text-sm font-bold text-emerald-400 mt-1">
            {user.miningActive ? 'Active' : 'Paused'}
          </div>
          <div className="text-[10px] text-slate-500">Verified PoP</div>
        </div>
        <div className="p-3 rounded-2xl bg-[#111420] border border-white/10 text-center">
          <div className="text-[10px] font-mono text-slate-400 uppercase">Next Claim</div>
          <div className="text-sm font-bold text-cyan-400 font-mono mt-1">{hours}h {minutes}m</div>
          <div className="text-[10px] text-slate-500">Auto-credited</div>
        </div>
      </div>
      ...
      <div className="p-4 rounded-2xl bg-[#0F1622] border border-cyan-500/25 flex items-start gap-3">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[11px] text-slate-300 leading-relaxed">
            VandeCoin does not require your phone to perform energy-intensive Proof-of-Work (PoW) computation. Rewards are minted via our lightweight Proof-of-Participation protocol that verifies authentic user identity, engagement, and network presence without heating or wearing down your device hardware.
          </p>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xs font-bold text-white">Mining Streak: {user.streakDays} Days</h3>
              <p className="text-[11px] text-slate-400">14 / 30 Days to Legend tier</p>
            </div>
          </div>
        ...
        <div className="w-full h-2 rounded-full bg-white/10 overflow-hidden">
          <div 
            className="h-full rounded-full bg-gradient-to-r from-[#FF9933] to-[#F59E0B] shadow-gold-glow"
            style={{ width: '46.6%' }}
          />
        </div>
      </div>
      ...
      <div className="p-4 rounded-2xl glass-panel border border-white/10 space-y-3">
        ...
        <div className="space-y-2.5 pt-1 text-xs">
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="font-bold text-white">Start your daily session</span>
              <p className="text-[11px] text-slate-400 mt-0.5">Tap once every 24 hours to prove active participation.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="font-bold text-white">Stay active</span>
              <p className="text-[11px] text-slate-400 mt-0.5">Keep the app installed and connected to the VandeCoin network.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="font-bold text-white">Complete eligible activities</span>
              <p className="text-[11px] text-slate-400 mt-0.5">Boost rates by taking VandeQuiz and verifying trust circles.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="font-bold text-white">Maintain your streak</span>
              <p className="text-[11px] text-slate-400 mt-0.5">Earn cumulative multiplier bonuses up to +50% extra VDC.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <span className="font-bold text-white">Earn VDC rewards</span>
              <p className="text-[11px] text-slate-400 mt-0.5">Rewards are distributed directly to your verified on-chain account.</p>
            </div>
          </div>
        </div>
      </div>
